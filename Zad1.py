...
while run:
    ...
    pygame.draw.rect(win, NIEBIESKI, (210, 250, 180, 100))
    pygame.draw.polygon(win, NIEBIESKI, [(300, 350), (250, 450), (350, 450)])
    pygame.draw.polygon(win, NIEBIESKI, [(300, 250), (250, 150), (350, 150)])
    # rysowanie kwadratów
