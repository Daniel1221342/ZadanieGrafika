...
pygame.display.set_caption("Transformacje z pygame.transform")
...
# Tworzenie trójkąta na Surface
def create_triangle_surface():
    surface = pygame.Surface((200, 200), pygame.SRCALPHA)
    triangle = [(100, 0), (200, 200), (0, 200)]
    pygame.draw.polygon(surface, CZERWONY, triangle)
    return surface

original_surface = create_triangle_surface()
